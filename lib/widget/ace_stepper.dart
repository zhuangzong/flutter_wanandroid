...
class _ACEStepperState extends State<ACEStepper> with TickerProviderStateMixin {
  ...
  Widget _buildIcon(IconType type, CircleData circleData, int index) {
    Color contentActiveColor = widget.themeData == null
        ...
        : widget.themeData!.contentActiveColor;
    Color contentColor = widget.themeData == null
        ? _kContentColor
        : widget.themeData!.contentColor;
    Color _color =
        widget.steps[index].isActive ? contentActiveColor : contentColor;
    double size = widget.steps[index].isNeedCircle
        ? _kCircleIconSize
        : _kCircleIconSizeBig;
    switch (type) {
      case IconType.text:
      ...
      case IconType.icon:
        return circleData.circleIcon != null
            ? Icon(circleData.circleIcon,
                size: size, color: circleData.iconColor)
  ...
  Widget _buildCircle(
    ...
    Color circleActiveColor = widget.themeData == null
        ? _kCircleActiveColor
        : widget.themeData!.circleActiveColor;
    Color circleColor = widget.themeData == null
        ? _kCircleColor
        : widget.themeData!.circleColor;
    return Stack(children: <Widget>[
      widget.steps[index].isNeedCircle
          ? Container(
              child: CustomPaint(
      ...
      Column(mainAxisSize: MainAxisSize.max, children: <Widget>[
        ...
        _buildCircle(
            ...
            widget.themeData == null
                ? _kCircleDiameter
                : widget.themeData!.circleDiameter,
      ...
      color: Colors.white,
        ...
        child: Row(children: <Widget>[
          widget.currentStep != 0
              ? InkWell(
                  onTap: () => {
                        widget.onStepTapped!(widget.currentStep > 0
                            ? widget.currentStep - 1
                            : widget.currentStep),
                        scroll(widget.currentStep - 1),
                      },
                  child: Container(
...
class _LinePainter extends CustomPainter {
  ...
  _LinePainter({required this.color, required this.radius, required this.type});
...
class _CirclePainter extends CustomPainter {
  ...
  _CirclePainter({required this.color, required this.size});
...
// toptips height
const double _kTopTipsHeight = 25.0;
// circle diameter
...
const double _kCircleIconSizeBig = 26.0;
// circle active color
