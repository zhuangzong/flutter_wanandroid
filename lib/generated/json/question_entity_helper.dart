...
questionEntityFromJson(QuestionEntity data, Map<String, dynamic> json) {
	...
	if (json['datas'] != null) {
		data.datas = (json['datas'] as List).map((v) => QuestionDatas().fromJson(v)).toList();
	}
	if (json['offset'] != null) {
...
questionDatasFromJson(QuestionDatas data, Map<String, dynamic> json) {
	...
	if (json['tags'] != null) {
		data.tags = (json['tags'] as List).map((v) => QuestionDatasTags().fromJson(v)).toList();
	}
	if (json['title'] != null) {
...
Map<String, dynamic> questionDatasToJson(QuestionDatas entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
questionDatasTagsFromJson(QuestionDatasTags data, Map<String, dynamic> json) {
	if (json['name'] != null) {
...
Map<String, dynamic> questionDatasTagsToJson(QuestionDatasTags entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
