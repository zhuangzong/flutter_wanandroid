...
mainTopListEntityFromJson(MainTopListEntity data, Map<String, dynamic> json) {
	...
	if (json['tags'] != null) {
		data.tags = (json['tags'] as List).map((v) => MainTopListTags().fromJson(v)).toList();
	}
	if (json['title'] != null) {
...
Map<String, dynamic> mainTopListEntityToJson(MainTopListEntity entity) {
...
mainTopListTagsFromJson(MainTopListTags data, Map<String, dynamic> json) {
	if (json['name'] != null) {
...
Map<String, dynamic> mainTopListTagsToJson(MainTopListTags entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
