...
mainListEntityFromJson(MainListEntity data, Map<String, dynamic> json) {
	...
	if (json['datas'] != null) {
		data.datas = (json['datas'] as List).map((v) => MianListDatas().fromJson(v)).toList();
	}
	if (json['offset'] != null) {
...
Map<String, dynamic> mainListEntityToJson(MainListEntity entity) {
...
mianListDatasFromJson(MianListDatas data, Map<String, dynamic> json) {
...
Map<String, dynamic> mianListDatasToJson(MianListDatas entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
