...
coinListEntityFromJson(CoinListEntity data, Map<String, dynamic> json) {
	...
	if (json['datas'] != null) {
		data.datas = (json['datas'] as List).map((v) => CoinListDatas().fromJson(v)).toList();
	}
	if (json['offset'] != null) {
...
coinListDatasFromJson(CoinListDatas data, Map<String, dynamic> json) {
