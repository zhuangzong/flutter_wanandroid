...
coinRankEntityFromJson(CoinRankEntity data, Map<String, dynamic> json) {
	...
	if (json['datas'] != null) {
		data.datas = (json['datas'] as List).map((v) => CoinRankDatas().fromJson(v)).toList();
	}
	if (json['offset'] != null) {
...
coinRankDatasFromJson(CoinRankDatas data, Map<String, dynamic> json) {
